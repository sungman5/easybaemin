...
export default function Basic_id_1() {
    return (
        <section className="leading-relaxed">
            <h1 className="mb-4 text-2xl font-hanna md:text-3xl lg:text-5xl lg:mb-10">배달앱 용어사전</h1>
            <ul>
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna md:text-2xl text-BMprimary">배달팁</h3>
                    ...
                    <p className="text-base text-gray-500">
                        ...
                        </svg>&nbsp;&ldquo;피자가 2만 원, 배달팁이 2천 원이니까 모두 2만 2천 원이네.&rdquo;</p>
                </li>
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl md:text-2xl font-hanna text-BMprimary">최소주문금액</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl md:text-2xl font-hanna text-BMprimary">찜</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna md:text-2xl text-BMprimary">리뷰</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary md:text-2xl">별점</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary md:text-2xl">배민페이</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary md:text-2xl">배민1</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary md:text-2xl">한집배달</h3>
                    <p className="md:leading-relaxed md:text-lg md:mb-2">한 번에 한 집만 배달하는 것. 여러 집을 들르지 않고 우리 집으로 바로 음식을 배달해준다.</p><p className="text-base text-gray-500">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline w-6 h-6 text-BMtertiary">
                            <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm2.023 6.828a.75.75 0 10-1.06-1.06 3.75 3.75 0 01-5.304 0 .75.75 0 00-1.06 1.06 5.25 5.25 0 007.424 0z" clipRule="evenodd" />
                        </svg>&nbsp;&ldquo;배고프니까 한집배달로 빨리 받아 봐야지!&rdquo;</p>
                </li>
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary md:text-2xl">알뜰배달</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary md:text-2xl">소스</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary md:text-2xl">토핑</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary md:text-2xl">사이드 메뉴</h3>
                ...
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary md:text-2xl">닉네임</h3>
                ...
                <li className="py-4">
                    <h3 className="mb-2 text-xl font-hanna text-BMprimary">랜덤</h3>
                    <p className="md:leading-relaxed md:text-lg md:mb-2">정하지 않고 아무 것이나 뽑는 것. 어떤 것이 뽑힐지 알 수 없다.</p>
                    <p className="text-base text-gray-500">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline w-6 h-6 text-BMtertiary">
                            <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm2.023 6.828a.75.75 0 10-1.06-1.06 3.75 3.75 0 01-5.304 0 .75.75 0 00-1.06 1.06 5.25 5.25 0 007.424 0z" clipRule="evenodd" />
                        </svg>&nbsp;&ldquo;리뷰를 써준 분들에게 무료 음료수를 랜덤으로 드립니다.&rdquo;</p>
                </li>
            </ul>
        </section>
    )
